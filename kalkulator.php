...
<body>
    <form method="POST">
    <label>Masukan bilangan 1 </label> <input type="text" name="bilangan1" value="<?php echo @$_POST['bilangan1'] ?>"><br><br>
    <label>Masukan bilangan 2 </label><input type="text" name="bilangan2" value="<?php echo @$_POST['bilangan2'] ?>"><br><br>
    ...
    <button type="submit">Menghitung</button><br><br>
    </form>
    <?php
        if ($_POST):
            $a = @$_POST['bilangan1'];
